...
def run_training(dataset_df : pd.DataFrame, num_trials: int = 30, num_epochs: int = 30) -> typing.Dict[str, optuna.Study]:
    ...
    # lstm_study.optimize(lambda trial: lstm_mdn_objective(trial, dataset_df, num_epochs), n_trials=num_trials)
